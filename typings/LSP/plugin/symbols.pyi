...
from ..protocol import (
    DocumentSymbol,
    DocumentSymbolParams as DocumentSymbolParams,
    Location,
    Range,
    SymbolInformation,
    SymbolKind,
...
from .core.input_handlers import (
    DynamicListInputHandler as DynamicListInputHandler,
...
class LspDocumentSymbolsCommand(LspTextCommand):
    ...
    def handle_response_async(
        self, response: list[DocumentSymbol] | list[SymbolInformation] | None
    ) -> None: ...
...
class LspWorkspaceSymbolsCommand(LspWindowCommand):
    ...
    def _on_resolved_symbol_async(
        self, session_name: str, response: WorkspaceSymbol
    ) -> None: ...
...
class WorkspaceSymbolsInputHandler(DynamicListInputHandler):
    ...
    def _handle_response_async(
        self,
        session_name: str,
        response: list[SymbolInformation] | list[WorkspaceSymbol] | None,
    ) -> list[sublime.ListInputItem]: ...
    def _on_all_responses(
        self, change_count: int, item_lists: list[list[sublime.ListInputItem]]
    ) -> None: ...
