...
from ..protocol import (
    ...
    DocumentDiagnosticParams as DocumentDiagnosticParams,
    DocumentDiagnosticReport,
    DocumentLink as DocumentLink,
    DocumentUri as DocumentUri,
    FullDocumentDiagnosticReport as FullDocumentDiagnosticReport,
    InlayHint as InlayHint,
    InlayHintParams as InlayHintParams,
...
class SessionBuffer:
    ...
    _document_diagnostic_pending_request: PendingDocumentDiagnosticRequest | None
    ...
    def _on_after_change_async(
        self, view: sublime.View, version: int, suppress_requests: bool = False
    ) -> None: ...
    ...
    def _if_view_unchanged(
        self, f: Callable[[sublime.View, Any], None], version: int
    ) -> CallableWithOptionalArguments:
        """
    ...
    def _on_color_boxes_async(
        self, view: sublime.View, response: list[ColorInformation]
    ) -> None: ...
    def clear_color_boxes_async(self) -> None: ...
    def _do_document_link_async(self, view: sublime.View, version: int) -> None: ...
    def _on_document_link_async(
        self, view: sublime.View, response: list[DocumentLink] | None
    ) -> None: ...
    ...
    def _on_document_diagnostic_async(
        self, version: int, response: DocumentDiagnosticReport
    ) -> None: ...
    ...
    def _on_document_diagnostic_error_async(
        self, version: int, error: ResponseError
    ) -> None: ...
    ...
    def _on_semantic_tokens_viewport_async(
        self, view: sublime.View, response: dict | None
    ) -> None: ...
    ...
    def _on_code_lenses_async(
        self, view: sublime.View, response: list[CodeLens] | None
    ) -> None: ...
