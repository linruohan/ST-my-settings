...
from ..protocol import (
    ...
    FoldingRangeParams as FoldingRangeParams,
    Range as Range,
)
...
class LspFoldCommand(LspTextCommand):
    ...
    def _handle_response_async(
        self, change_count: int, response: list[FoldingRange] | None
    ) -> None: ...
    def description(
        self,
        prefetch: bool = False,
    ...
    def _handle_response_manual_async(
        self, point: int, strict: bool, response: list[FoldingRange] | None
    ) -> None: ...
...
class LspFoldAllCommand(LspTextCommand):
    ...
    def _handle_response_async(
        self, kind: str | None, response: list[FoldingRange] | None
    ) -> None: ...
