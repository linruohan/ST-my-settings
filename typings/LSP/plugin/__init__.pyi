...
from .core.file_watcher import (
    ...
    FileWatcherEventType as FileWatcherEventType,
    FileWatcherProtocol as FileWatcherProtocol,
    register_file_watcher_implementation as register_file_watcher_implementation,
)
