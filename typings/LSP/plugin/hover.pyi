...
from .code_actions import (
    CodeActionOrCommand as CodeActionOrCommand,
    CodeActionsByConfigName as CodeActionsByConfigName,
    actions_manager as actions_manager,
)
...
from .core.open import (
    lsp_range_from_uri_fragment as lsp_range_from_uri_fragment,
...
from .core.views import (
    FORMAT_MARKED_STRING as FORMAT_MARKED_STRING,
    ...
    format_code_actions_for_quick_panel as format_code_actions_for_quick_panel,
    format_diagnostic_for_html as format_diagnostic_for_html,
...
class LinkKind:
    ...
    def __init__(
        self, lsp_name: str, label: str, subl_cmd_name: str, supports_side_by_side: bool
    ) -> None: ...
    def link(self, point: int, view: sublime.View) -> str: ...

link_kinds: Incomplete

def code_actions_content(
    actions_by_config: list[CodeActionsByConfigName], lightbulb: bool = True
) -> str: ...
...
class LspHoverCommand(LspTextCommand):
    ...
    def request_symbol_hover_async(
        self, listener: AbstractViewListener, point: int
    ) -> None: ...
    def _on_all_settled(
        self,
    ...
    def _on_resolved_link(
        self, session_buffer: SessionBufferProtocol, link: DocumentLink
    ) -> DocumentLink: ...
    ...
    def provider_exists(
        self, listener: AbstractViewListener, link: LinkKind
    ) -> bool: ...
    def symbol_actions_content(
        self, listener: AbstractViewListener, point: int
    ) -> str: ...
    ...
    def handle_code_action_select(
        self, config_name: str, actions: list[CodeActionOrCommand], index: int
    ) -> None: ...
