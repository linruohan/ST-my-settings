...
class QueryCompletionsTask:
    ...
    def _create_completion_request_async(
        self, session: Session
    ) -> Promise[ResolvedCompletions]: ...
    ...
    def _resolve_completions_async(
        self, responses: list[ResolvedCompletions]
    ) -> None: ...
    ...
    def _resolve_task_async(
        ...
        flags: sublime.AutoCompleteFlags,
    ) -> None: ...
...
class LspResolveDocsCommand(LspTextCommand):
    ...
    def _handle_resolve_response_async(
        self, language_map: MarkdownLangMap | None, item: CompletionItem
    ) -> None: ...
...
class LspSelectCompletionCommand(LspTextCommand):
    ...
    def _translated_regions(
        self, edit_region: sublime.Region
