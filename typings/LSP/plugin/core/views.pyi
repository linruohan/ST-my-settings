...
from ...protocol import (
    ...
    CodeActionKind,
    CodeActionParams as CodeActionParams,
    Color as Color,
    ColorInformation as ColorInformation,
    Command as Command,
    Diagnostic as Diagnostic,
    DiagnosticRelatedInformation as DiagnosticRelatedInformation,
    DiagnosticSeverity,
    DidChangeTextDocumentParams as DidChangeTextDocumentParams,
    DidCloseTextDocumentParams as DidCloseTextDocumentParams,
    DidOpenTextDocumentParams as DidOpenTextDocumentParams,
    DidSaveTextDocumentParams as DidSaveTextDocumentParams,
    DocumentColorParams as DocumentColorParams,
    DocumentUri,
    Location,
    LocationLink,
    MarkedString as MarkedString,
    MarkupContent as MarkupContent,
    Position as Position,
    Range as Range,
    SelectionRangeParams as SelectionRangeParams,
    TextDocumentContentChangeEvent as TextDocumentContentChangeEvent,
    TextDocumentIdentifier as TextDocumentIdentifier,
    TextDocumentItem as TextDocumentItem,
    TextDocumentPositionParams as TextDocumentPositionParams,
    TextDocumentSaveReason as TextDocumentSaveReason,
    VersionedTextDocumentIdentifier as VersionedTextDocumentIdentifier,
    WillSaveTextDocumentParams as WillSaveTextDocumentParams,
)
...
DIAGNOSTIC_SEVERITY: list[
    tuple[str, str, str, str, sublime.RegionFlags, sublime.RegionFlags]
]
...
def did_change_text_document_params(
    view: sublime.View,
    version: int,
    changes: Iterable[sublime.TextChange] | None = None,
...
def _html_element(
    name: str, text: str, class_name: str | None = None, escape: bool = True
) -> str: ...
def format_diagnostic_for_html(
    config: ClientConfig, diagnostic: Diagnostic, base_dir: str | None = None
) -> str: ...
