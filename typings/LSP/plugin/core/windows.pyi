...
from .protocol import Error as Error
...
class WindowManager(Manager, WindowConfigChangeListener):
    ...
    def _publish_sessions_to_listener_async(
        self, listener: AbstractViewListener
    ) -> None: ...
    ...
    def handle_message_request(
        self, session: Session, params: ShowMessageRequestParams, request_id: Any
    ) -> None: ...
    ...
    def handle_log_message(
        self, session: Session, params: LogMessageParams
    ) -> None: ...
...
class PanelLogger(Logger):
    ...
    def _format_response(
        self, direction: str, request_id: Any, duration: str
    ) -> str: ...
...
class RemoteLogger(Logger):
    ...
    def _on_message_received(
        self, client: dict, server: WebsocketServer, message: str
    ) -> None:
