...
from .protocol import Error as Error, Notification as Notification, Request as Request, ResolvedCodeLens as ResolvedCodeLens, Response as Response, ResponseError as ResponseError
...
from .types import Capabilities as Capabilities, ClientConfig as ClientConfig, ClientStates as ClientStates, DocumentSelector as DocumentSelector, SemanticToken as SemanticToken, SettingsRegistration as SettingsRegistration, WORKSPACE_DIAGNOSTICS_TIMEOUT as WORKSPACE_DIAGNOSTICS_TIMEOUT, debounced as debounced, diff as diff, method_to_capability as method_to_capability, sublime_pattern_to_glob as sublime_pattern_to_glob
...
class Session(TransportCallbacks):
    ...
    def execute_command(self, command: ExecuteCommandParams, *, progress: bool = False, view: sublime.View | None = None, is_refactoring: bool = False) -> Promise[LSPAny | Error]:
