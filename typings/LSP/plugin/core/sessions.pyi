...
from ...protocol import (
    ApplyWorkspaceEditParams as ApplyWorkspaceEditParams,
    ClientCapabilities as ClientCapabilities,
    CodeAction,
    Command,
    ConfigurationItem as ConfigurationItem,
    ConfigurationParams as ConfigurationParams,
    ...
    DidChangeWorkspaceFoldersParams as DidChangeWorkspaceFoldersParams,
    DocumentLink as DocumentLink,
    DocumentUri as DocumentUri,
    ExecuteCommandParams as ExecuteCommandParams,
    FileEvent as FileEvent,
    FileSystemWatcher as FileSystemWatcher,
    GeneralClientCapabilities as GeneralClientCapabilities,
    InitializeError as InitializeError,
    InitializeParams as InitializeParams,
    InitializeResult as InitializeResult,
    Location as Location,
    LocationLink as LocationLink,
    LogMessageParams as LogMessageParams,
    PreviousResultId as PreviousResultId,
    ProgressParams as ProgressParams,
    ProgressToken as ProgressToken,
    PublishDiagnosticsParams as PublishDiagnosticsParams,
    Range as Range,
    RegistrationParams as RegistrationParams,
    ShowDocumentParams as ShowDocumentParams,
    ShowMessageParams as ShowMessageParams,
    ShowMessageRequestParams as ShowMessageRequestParams,
    SignatureHelpTriggerKind,
    TextDocumentClientCapabilities as TextDocumentClientCapabilities,
    TextDocumentSyncKind as TextDocumentSyncKind,
    TextEdit as TextEdit,
    UnregistrationParams as UnregistrationParams,
    WatchKind as WatchKind,
    WindowClientCapabilities as WindowClientCapabilities,
    WorkDoneProgressBegin,
    WorkDoneProgressCreateParams as WorkDoneProgressCreateParams,
    WorkspaceClientCapabilities as WorkspaceClientCapabilities,
    WorkspaceDiagnosticParams as WorkspaceDiagnosticParams,
    WorkspaceDiagnosticReport,
    WorkspaceDocumentDiagnosticReport as WorkspaceDocumentDiagnosticReport,
...
from .types import (
    ...
    DocumentSelector as DocumentSelector,
    SemanticToken as SemanticToken,
    SettingsRegistration as SettingsRegistration,
    WORKSPACE_DIAGNOSTICS_TIMEOUT as WORKSPACE_DIAGNOSTICS_TIMEOUT,
...
class SessionBufferProtocol(Protocol):
    ...
    def set_semantic_tokens_pending_refresh(
        self, needs_refresh: bool = ...
    ) -> None: ...
    def get_semantic_tokens(self) -> list[SemanticToken]: ...
    def evaluate_semantic_tokens_color_scheme_support(
    ...
    def set_document_diagnostic_pending_refresh(
        self, needs_refresh: bool = ...
    ) -> None: ...
...
def _register_plugin_impl(
    plugin: type[AbstractPlugin], notify_listener: bool
) -> None: ...
...
class Logger(metaclass=ABCMeta):
    ...
    def incoming_response(
        self, request_id: int | None, params: Any, is_error: bool
    ) -> None: ...
    @abstractmethod
...
class Session(TransportCallbacks):
    ...
    request_id: int
    _logger: Incomplete
    _response_handlers: dict[int, tuple[Request, Callable, Callable[[Any], None]]]
    config: Incomplete
    ...
    def _set_view_state(
        self, actions: ViewStateActions, view: sublime.View
    ) -> Promise[None]: ...
    ...
    def session_views_by_visibility(
        self,
    ) -> tuple[set[SessionViewProtocol], set[SessionViewProtocol]]: ...
    ...
    def m_window_showMessageRequest(
        self, params: ShowMessageRequestParams, request_id: Any
    ) -> None:
    ...
    def m_workspace_configuration(
        self, params: ConfigurationParams, request_id: Any
    ) -> None:
        """handles the workspace/configuration request"""

    def m_workspace_applyEdit(
        self, params: ApplyWorkspaceEditParams, request_id: Any
    ) -> None:
    ...
    def m_textDocument_publishDiagnostics(
        self, params: PublishDiagnosticsParams
    ) -> None:
        """handles the textDocument/publishDiagnostics notification"""

    def m_client_registerCapability(
        self, params: RegistrationParams, request_id: Any
    ) -> None:
        """handles the client/registerCapability request"""

    def m_client_unregisterCapability(
        self, params: UnregistrationParams, request_id: Any
    ) -> None:
    ...
    def m_window_showDocument(
        self, params: ShowDocumentParams, request_id: Any
    ) -> None:
        """handles the window/showDocument request"""

    def m_window_workDoneProgress_create(
        self, params: WorkDoneProgressCreateParams, request_id: Any
    ) -> None:
        """handles the window/workDoneProgress/create request"""

    def _invoke_views(self, request: Request, method: str, *args: Any) -> None: ...
    def _create_window_progress_reporter(
        self, token: ProgressToken, value: WorkDoneProgressBegin
    ) -> None: ...
