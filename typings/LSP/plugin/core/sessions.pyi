...
class Session(TransportCallbacks):
    ...
    def apply_workspace_edit_async(self, edit: WorkspaceEdit, *, label: str | None = None, is_refactoring: bool = False) -> Promise[None]:
        """
    ...
    def _apply_text_edits(self, edits: list[TextEdit], label: str | None, view_version: int | None, uri: str, view: sublime.View | None) -> sublime.View | None: ...
