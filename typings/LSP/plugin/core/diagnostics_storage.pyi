from ...protocol import Diagnostic as Diagnostic, DocumentUri as DocumentUri
...
class DiagnosticsStorage(OrderedDict):
    def add_diagnostics_async(
        self, document_uri: DocumentUri, diagnostics: list[Diagnostic]
    ) -> None:
        """
