...
from typing import Any, Callable, Generic, Iterable, Mapping, TypeVar, TypedDict
...
class Request(Generic[R]):
    ...
    def __init__(self, method: str, params: Any = None, view: sublime.View | None = None, progress: bool = False, on_partial_result: Callable[[Any], None] | None = None) -> None: ...
    @classmethod
    ...
    @classmethod
    def workspaceDiagnostic(cls, params: WorkspaceDiagnosticParams, on_partial_result: Callable[[WorkspaceDiagnosticReport], None]) -> Request: ...
    @classmethod
