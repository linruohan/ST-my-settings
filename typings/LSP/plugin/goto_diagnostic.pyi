...
from ..protocol import Diagnostic, DocumentUri as DocumentUri, Location as Location
from .core.constants import DIAGNOSTIC_KINDS as DIAGNOSTIC_KINDS
from .core.diagnostics_storage import (
    ParsedUri as ParsedUri,
    is_severity_included as is_severity_included,
)
from .core.input_handlers import (
    PreselectedListInputHandler as PreselectedListInputHandler,
)
from .core.paths import (
    project_base_dir as project_base_dir,
    project_path as project_path,
    simple_project_path as simple_project_path,
)
...
from .core.views import (
    ...
    format_diagnostic_source_and_code as format_diagnostic_source_and_code,
    format_severity as format_severity,
...
class LspGotoDiagnosticCommand(sublime_plugin.WindowCommand):
    ...
    def is_enabled(
        self, uri: DocumentUri | None = None, diagnostic: dict | None = None
    ) -> bool: ...
...
class DiagnosticUriInputHandler(PreselectedListInputHandler):
    ...
    def name(self) -> str: ...
    first_locations: dict[ParsedUri, tuple[Session, Location]]
...
class DiagnosticInputHandler(sublime_plugin.ListInputHandler):
    ...
    def __init__(
        self, window: sublime.Window, view: sublime.View, uri: DocumentUri
    ) -> None: ...
    def name(self) -> str: ...
...
def diagnostic_html(
    config: ClientConfig, diagnostic: Diagnostic, base_dir: Path | None
) -> sublime.Html: ...
