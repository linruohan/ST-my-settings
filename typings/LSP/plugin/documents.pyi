...
from ..protocol import (
    ...
    SignatureHelpContext as SignatureHelpContext,
    SignatureHelpParams as SignatureHelpParams,
...
class DocumentSyncListener(sublime_plugin.ViewEventListener, AbstractViewListener):
    ...
    _lightbulb_line: int | None
    _diagnostics_for_selection: list[tuple[SessionBufferProtocol, list[Diagnostic]]]
    _code_actions_for_selection: list[CodeActionsByConfigName]
    _registered: bool
    ...
    def _diagnostics_async(self, allow_stale: bool = False) -> Generator[
        tuple[SessionBufferProtocol, list[tuple[Diagnostic, sublime.Region]]],
        None,
        None,
    ]: ...
    @override
    ...
    @requires_session
    def on_text_command(
        self, command_name: str, args: dict | None
    ) -> tuple[str, dict] | None: ...
    @requires_session
    ...
    def _show_sighelp_popup(
        self, sighelp: SigHelp, content: str, point: int
    ) -> None: ...
    ...
    def _on_initial_folding_ranges(
        self, kinds: list[str], response: list[FoldingRange] | None
    ) -> None: ...
    def session_async(
    ...
    def _when_selection_remains_stable_async(
        self, f: Callable[[], None], r: sublime.Region, after_ms: int
    ) -> None: ...
